...
public enum HttpStatus {
	...
	ERR_CONNECTION(-1, "Error Connection Time out"),
	 ...
	 */
	LOAD_BALANCE_X_FORWARDED_FOR_OVERSIZE(463, "X-Forwarded-For request header oversize"),
	...
	public boolean isErrorConnection() {
		return (Series.ERROR.equals(series()));
	}
